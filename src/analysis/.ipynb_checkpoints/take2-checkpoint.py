...
# +
mgp.trainModel2(a,b,c,d, 80, 300, 80, .2)
...
plt.plot(y_val[15000:LIM,0], label='Observation')
plt.plot(y_hat_d[15000:LIM,0], label='Predictions', linestyle='-.', color = 'r')
plt.legend()
plt.grid(linestyle = '--')
