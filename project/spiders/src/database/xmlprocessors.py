...
def process_OffPub(fname):
	"""Process the public offers file.
	...
	pandas.DataFrame, pandas.DataFrame
		Dataframes containing the demand and supply data
	"""
...
def getCurve(df):
	"""Evaluate the demand and supply curves.
	
	Parameters
	----------
	df : pandas.DataFrame
		Dataframe of bids or offers
	
	Returns
	-------
	pandas.DataFrame
		Dataframe of the demand or supply curve
	"""
...
def type_conv(path, key, value):
	"""Auxiliary function for type conversion
	of the xmltodict library
	"""
...
def dataPool(converted, m):
	"""Pooling data from public offers to evaluate the 
	...
	-------
	pandas.DataFrame, pandas.DataFrame
		Dataframe of the demand and supply curves
	"""
